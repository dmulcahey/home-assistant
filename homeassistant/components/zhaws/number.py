...
REGISTER_CLASS = functools.partial(ENTITY_CLASS_REGISTRY.register, Platform.NUMBER)
    ...
    for device in devices.values():
        for entity in device.device.entities.values():
            ...
            if entity.platform != Platform.NUMBER:
                continue
            entity_class = ENTITY_CLASS_REGISTRY[Platform.NUMBER][entity.class_name]
            _LOGGER.warning(
...
class ZhaNumber(ZhaEntity, NumberEntity):
    ...
    def min_value(self):
        ...
        min_present_value = self._platform_entity.min_value
    ...
    def max_value(self):
        ...
        max_present_value = self._platform_entity.max_value
    ...
    def step(self):
        ...
        resolution = self._platform_entity.step
    ...
    def name(self):
        ...
        description = self._platform_entity.name
    ...
    def icon(self):
        ...
        application_type = self._platform_entity.application_type
    ...
    def unit_of_measurement(self):
        ...
        engineering_units = self._platform_entity.engineering_units
